...
::: box
::: box-header
Today's puzzle - The Algorithm Dilemma
:::

::: box-container
**Situation:**

You are a data analyst for a popular streaming service. The company is testing two different recommendation algorithms to determine which one provides better movie recommendations for its users. The company has conducted an A/B test where users are randomly assigned to either Algorithm A or Algorithm B, and their satisfaction levels are recorded after watching recommended movies.

The results of the test are as follows:

-   Algorithm A: 70% of users reported high satisfaction.

-   Algorithm B: 75% of users reported high satisfaction.

**Your task:**

Based on the information provided, what is one factor that you should consider before concluding that Algorithm B is better than Algorithm A? State and explain the factor.
