...
In this issue, we are excited to highlight several data science initiatives from the Nigeria Monitoring Project (NMP) spanning 2019 to 2024. This project provided third-party monitoring (TPM) services to assess, verify, and analyze trends in the Bureau of Humanitarian Assistance (BHA) programs in three northeastern states of Nigeria. NMP monitored 20 sites each month across various sectors, including WASH, nutrition, food assistance, health, shelter and settlements, protection, and warehouse and commodity management. Utilizing an array of research methods and both in-person and remote monitoring techniques, NMP supplied BHA with critical evidence for decision-making across six TPM themes.
...
In 2023, NMP conducted a special study to test the use of an image segmentation model with an artificial intelligence (AI) application on four warehouses. This Tetra Tech proprietary product, previously used for infrastructure assessments like building safety inspections and wastewater treatment plant evaluations, was a first for BHA's TPM efforts. The innovative study's results were widely shared, with Carolyn Fonseca discussing the use of AI in monitoring and evaluation on the
[European Evaluation Society's EvalEdge Podcast](https://soundcloud.com/europeanevaluationsociety/evaledge-ep21-ai-monitoring-evaluation-in-challenging-environments).

As NMP approached its close, the data science team recognizes their invaluable contributions to MSI and extended heartfelt thanks to the entire team for their dedication to advancing data science. Your hard work and innovation have set a new standard in monitoring and evaluation, and we look forward to seeing the lasting impact of your achievements.

![NMP Team Photo](../viz/NMP team.png)
