...
The Data Science Team plans to roll out DST brown bags pulling from these training topics over the next several months. The pre-recorded training videos are found [here](https://www.youtube.com/playlist?list=PLHwXAdVj07tsPrPqtiXY3a68vEc2OImkQ).
